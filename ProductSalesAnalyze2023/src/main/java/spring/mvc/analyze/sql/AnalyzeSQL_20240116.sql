...
-- -----------------------------------------------------
-- Table `analyze`.`ecProductType`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `analyze`.`ecProductType` ;

CREATE TABLE IF NOT EXISTS `analyze`.`ecProductType` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(100) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `name_UNIQUE` (`name` ASC) VISIBLE)
...
-- -----------------------------------------------------
-- Table `analyze`.`ecProductSubType`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `analyze`.`ecProductSubType` ;

CREATE TABLE IF NOT EXISTS `analyze`.`ecProductSubType` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(100) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `name_UNIQUE` (`name` ASC) VISIBLE)
...
CREATE TABLE IF NOT EXISTS `analyze`.`ecommerce` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `name_UNIQUE` (`name` ASC) VISIBLE,
  INDEX `ecommerce_ecProductType_idx` (`ecProductTypeId` ASC) VISIBLE,
  INDEX `ecommerce_ecProductSubType_idx` (`ecProductSubTypeId` ASC) VISIBLE,
  CONSTRAINT `product_productCategory`
    FOREIGN KEY (`productTypeId`)
    REFERENCES `analyze`.`ecProductType` (`id`),
  CONSTRAINT `product_productType`
    FOREIGN KEY (`productSubTypeId`)
    REFERENCES `analyze`.`ecProductSubType` (`id`)
) ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `analyze`.`product` (
  ...
  INDEX `product_productType_idx` (`productTypeId` ASC) VISIBLE,
  INDEX `product_productSubType_idx` (`productSubTypeId` ASC) VISIBLE,
  INDEX `product_ec_id_idx` (`ecId` ASC) VISIBLE,  -- 新增的索引
  CONSTRAINT `product_productType`
    FOREIGN KEY (`productTypeId`)
    REFERENCES `analyze`.`productType` (`id`),
  CONSTRAINT `product_productSubType`
    FOREIGN KEY (`productSubTypeId`)
