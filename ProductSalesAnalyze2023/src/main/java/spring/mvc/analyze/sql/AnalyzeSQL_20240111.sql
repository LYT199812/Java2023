...
-- -----------------------------------------------------
-- Table `analyze`.`department`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `analyze`.`department` ;

CREATE TABLE IF NOT EXISTS `analyze`.`department` (
...
CREATE TABLE IF NOT EXISTS `analyze`.`salesdata` (
  ...
  `productName` VARCHAR(50) NOT NULL,
  `ec_productDepartment` VARCHAR(50) NULL DEFAULT NULL,
...
-- Table `analyze`.`stcok`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `analyze`.`stcok` ;

CREATE TABLE IF NOT EXISTS `analyze`.`stcok` (
