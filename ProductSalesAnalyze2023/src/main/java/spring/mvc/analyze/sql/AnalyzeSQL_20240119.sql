...
-- -----------------------------------------------------
-- Table `analyze`.`productBrand`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `analyze`.`productBrand` ;

CREATE TABLE IF NOT EXISTS `analyze`.`productBrand` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(100) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `name_UNIQUE` (`name` ASC) VISIBLE)
...
CREATE TABLE IF NOT EXISTS `analyze`.`product` (
  ...
  INDEX `product_productBrand_idx` (`productBrandId` ASC) VISIBLE,
  ...
  CONSTRAINT `product_productBrand`
    FOREIGN KEY (`productBrandId`)
    REFERENCES `analyze`.`productBrand` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
